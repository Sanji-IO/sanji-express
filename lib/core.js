...
module.exports = SanjiExpress = function(app, options) {
  ...
  self.apiBase = self.options.apiBase || '';
  self.ramdiskPath = self.options.ramdiskPath || '/run/shm/';
  loaderOptions = self.options.loaderOptions || self.options.bundlesHome;

  self.loader = new Loader(loaderOptions);
