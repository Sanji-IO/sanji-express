...
module.exports = SanjiExpress = function(options) {
  ...
  // this.setupSanjiPuppetMaster(router);
...
// SanjiExpress.prototype.setupSanjiPuppetMaster = function(router, route) {
