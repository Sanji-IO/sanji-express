...
var proxyToFileBin = function (req, res, next) {
  ...
  var proxy = new Promise(function (resolve, reject) {
    var apiRequest = req.pipe(request({
      ...
      headers: {
        'X-Mx-AccessToken': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjEsImNyZWF0ZWRBdCI6MTQ1NjkwNzQ2MTgwOH0.EJcYj6n8jlCyUY_cZ_-dCjf8Y7UOWlIQg7IuNqgmYCI'//req.get('X-Mx-AccessToken')
      }
